...
//    public static final String CIPHER_ALGORITHM = "AES/ECB/NoPadding";
    ...
    public static String StartAES_encode(String ID) throws Exception{
        String key1 = "Gmcc@123";
        byte[] key = key1.getBytes("UTF-8");
        byte[] jimm = ID.getBytes();
        byte[] valueEncoded = Base64.encodeBase64(ID.getBytes());
        return(AESSecurityUtil.encrypt(valueEncoded, key)).toString();
    }
