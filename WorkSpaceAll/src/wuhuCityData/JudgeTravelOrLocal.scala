...
object JudgeTravelOrLocal {
     def main(args: Array[String]) {
       //      System.setProperty("hadoop.home.dir","D:\\lib\\hadoop")
          ...
          //val Date1=20160214
       for(Date1 <- 20160115 to 20160121)
       {
         ...
         deleteHDFSDir("hdfs://192.168.86.41:9000/user/wjchen/countTimes1/" + Date1)
         stayMoreThan2Hour.saveAsTextFile("hdfs://192.168.86.41:9000/user/wjchen/14DAY/" + Date1 + "/")
